...
public class CouchbaseSqlLikePattern {
    ...
    private CouchbaseSqlLikePattern() {
        this.plain = null;
        this.pattern = null;
    }

    private CouchbaseSqlLikePattern(@NotNull Pattern pattern) {
        this.plain = null;
        this.pattern = pattern;
    }

    private CouchbaseSqlLikePattern(@NotNull String plain) {
        this.plain = plain;
        this.pattern = null;
    }
    ...
    /**
     * Given an inputPattern using SQL syntax (e.g. % for wildcard, and '_' for single character)
     * generate a Java Pattern that can be used to validate input.
     *
     ...
     */
    @NotNull
    public static CouchbaseSqlLikePattern create(@Nullable String inputPattern) throws IllegalArgumentException {
        if (inputPattern == null) return new CouchbaseSqlLikePattern();
        String plain = toPlain(inputPattern);
        if (plain != null) return new CouchbaseSqlLikePattern(plain);
        ...
        return pattern.equals(".*") ? new CouchbaseSqlLikePattern() : new CouchbaseSqlLikePattern(Pattern.compile(pattern));
    }
