...
import com.intellij.types.ArrayImpl;
...
public class CouchbaseListResultSet implements ResultSet {

    private boolean isClosed = false;
    private CouchbaseResultSetMetaData metaData = new CouchbaseResultSetMetaData(Collections.emptyList());
    private final List<Map<String, Object>> rows;
    private int index = 0;
    private Map<String, Object> currentRow = null;

    public CouchbaseListResultSet(@NotNull QueryResult queryResult) {
       this.rows = queryResult.rowsAsObject().stream()
                .map(JsonObject::toMap)
                .collect(Collectors.toList());
    }

    public CouchbaseListResultSet(@NotNull List<Map<String, Object>> queryResult) {
        this.rows = queryResult;
    }

    private CouchbaseListResultSet() {
        this.rows = Collections.emptyList();
    }

    public static CouchbaseListResultSet empty() {
        return new CouchbaseListResultSet();
    }

    public void setMetadata(@NotNull CouchbaseResultSetMetaData metaData) {
        this.metaData = metaData;
    }

    public void addRows(@NotNull Collection<Map<String, Object>> newRows) {
        rows.addAll(newRows);
    }
    ...
    private Number getNumeric(String columnLabel) throws SQLException {
        ...
        Number number = (Number) currentRow.get(columnLabel);
    ...
    public String getString(String columnLabel) throws SQLException {
        ...
        Object str = currentRow.get(columnLabel);
    ...
    @Override
    public CouchbaseResultSetMetaData getMetaData() throws SQLException {
        return metaData;
    }
    ...
    public Array getArray(int columnIndex) throws SQLException {
        return getArray(getMetaData().getColumnLabel(columnIndex));
    }
    ...
    public Array getArray(String columnLabel) throws SQLException {
        ...
        return new ArrayImpl((List<?>) currentRow.get(columnLabel));
    }
